...
public class Menu {
	...
	public static void mostrarMenu() {
		...
		switch(opcao) {
			case 1: System.out.println("======= CADASTRO DE PEDIDO =======");		
			CadastrarPedido.cadastrarPedido();
				break;
			case 2: System.out.println("======= LISTA DE CLIENTES =======");
			...
			mostrarMenu();
				...
				break;
			case 3: System.out.println("======= IMPRIMIR PEDIDO / CLIENTE =======");
				
			try {
				
				Connection connection = Conexao.conectar();
				connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/sistema_pedido", "postgres", "123456");
			...
			Menu.mostrarMenu();
				...
				break;
			case 4: System.out.println("======= IMPRIMIR PEDIDO / CLIENTE / PRODUTO =======");
